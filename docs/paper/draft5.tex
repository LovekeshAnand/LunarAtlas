...
\subsection{Step 6: SNR Thresholding and Gaussian Peak Fitting}

To advance the pipeline beyond a pure infrastructure tier into
analysis-ready scientific data, the extraction of elemental fingerprints
...
\begin{enumerate}[nosep,leftmargin=*]
  ...
  \item \textbf{Isotropic Gaussian Fitting}: To accurately deduce peak centres
  ($\lambda_{\text{fit}}$) and quantitatively resolve overlapping features
  (e.g., the complex Mg~II / Ca~II doublets), high-prominence candidates
...
\subsection{Step 7: Metadata Association and Output Formatting}
...
% =========================================================================
\section{Scientific Results and Elemental Validation}
\label{sec:results}
% =========================================================================
...
\textbf{$\Delta\lambda$ (nm)} & \textbf{SNR ($>\!3\sigma$)} & \textbf{Intensity (cts)} & \textbf{Regolith Proxy} \\
\midrule
Mg~II & 279.55 & 279.71 & $+0.16$ & 28.4 & 684 & Dominant mafic phase (Pyroxene/Olivine)\\
Si~I  & 288.16 & 288.30 & $+0.14$ & 14.1 & 210 & Major silicate matrix component \\
Ti~II & 334.94 & 335.10 & $+0.16$ & 8.5  & 145 & Trace Ilmenite indicator \\
Ca~II & 393.37 & 393.55 & $+0.18$ & 31.2 & 580 & Plagioclase feldspar signature \\
Al~I  & 396.15 & 396.34 & $+0.19$ & 26.5 & 490 & Highland Anorthosite marker \\
Fe~I  & 404.58 & 404.75 & $+0.17$ & 11.3 & 205 & Mafic iron abundance proxy \\
...
detection~\cite{ISROCh3}. More importantly, the automated extraction of
these elemental fingerprints confirms the scientific utility of the
cleaned Level-1 spectra for mineralogical inference. 

Specifically, the prominence of Mg~II (280.2~nm) and Fe~I (404.5~nm)
signatures acts as a reliable proxy for mafic mineral phases such as
pyroxenes and olivine, common in mare basalts. Conversely, the strong
Ca~II (393.3~nm) and Al~I (396.1~nm) emission lines explicitly identified
in these spectra are highly characteristic of plagioclase feldspar, marking
the fundamental mineralogical signature of lunar highland anorthosite.
The detection of Si~I (288.1~nm) and O~I (777.4~nm) provides the baseline
refractory silicate matrix confirmation. By aligning these known NIST
transitions with the high signal-to-noise peaks extracted via the
LunarAtlas pipeline, researchers can map shot-to-shot elemental
variations without relying on subjective continuum removal heuristics.
