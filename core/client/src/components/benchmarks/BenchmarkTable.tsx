...
const MISSION_TABLE: TableConfig = {
  ...
  rows: [
    ...
    { Feature: 'Calibration', 'LunarAtlas (CH-3)': 'L1 pre-calibrated; processed', 'ChemCam CCS (Curiosity)': 'Raw → wavelength + ILS correction', 'SuperCam (Perseverance)': 'Multi-stage radiometric + λ', 'MarSCoDe (Zhurong)': 'Wavelength + intensity calib' },
