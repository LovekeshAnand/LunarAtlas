          ...
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} noValidate>
              ...
              <button
                id="signup-submit"
                type="submit"
                className="w-full py-[13px] bg-ink dark:bg-[#f0f0f0] text-white dark:text-[#0d0d0d] border-0 font-sans text-[11px] font-bold tracking-[2px] uppercase cursor-pointer transition-colors duration-150 hover:bg-[#333] dark:hover:bg-[#d0d0d0]"
              >
                Request Access
              </button>
            </form>
