  ...
  return (
    <div className="font-sans">
      ...
      {/* ═══════════════════════════════════════════════════
          HERO
      ═══════════════════════════════════════════════════ */}
      <section id="home-hero" className="border-b border-[#eee]">
        <div className="max-w-[1400px] mx-auto px-12 pt-[88px] pb-20 relative z-[1]">

          {/* Mission badge */}
          <div className="inline-flex items-center gap-2 border border-border-dark px-[14px] py-[5px] mb-8">
            <span className="w-[6px] h-[6px] rounded-full bg-ink inline-block" />
            <span className="text-[9px] font-bold tracking-[2px] text-[#666] uppercase">
              Chandrayaan-3 · LIBS · Level-1 · PDS4
            </span>
          </div>

          {/* Main wordmark */}
          <h1 className="font-sans text-[clamp(42px,7vw,86px)] font-bold tracking-[-1px] text-ink m-0 mb-[6px] leading-none">
            LUNAR<span className="font-light">ATLAS</span>
          </h1>

          {/* Tagline */}
          <div className="text-[clamp(14px,2vw,18px)] font-light text-[#555] tracking-[0.5px] mb-4 max-w-[600px] leading-[1.5]">
            From PDS4 Archives to Analysis-Ready Spectra
          </div>

          <div className="text-[12px] text-[#999] tracking-[0.3px] mb-10 max-w-[540px] leading-[1.6]">
          ...
          <div className="flex gap-3 flex-wrap">
            <button
              id="home-cta-signup"
              onClick={handleCTA}
              className="font-sans text-[11px] font-bold tracking-[2px] uppercase bg-ink text-white border-0 px-8 py-[14px] cursor-pointer transition-colors duration-150 hover:bg-[#333]"
            >
          ...
          {/* Stats row */}
          <div className="flex gap-0 mt-14 border-t border-[#eee] pt-7 flex-wrap">
            {[
              ...
              <div key={label} className="flex-[1_0_180px] pr-12 mb-3">
                <div className="text-[22px] font-bold text-ink tracking-[-0.5px]">{val}</div>
                <div className="text-[10px] text-[#999] tracking-[1px] uppercase mt-1">{label}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* ═══════════════════════════════════════════════════
          ABSTRACT
      ═══════════════════════════════════════════════════ */}
      <section id="home-abstract" className="bg-canvas-alt">
        <div className="max-w-[1400px] mx-auto px-12 py-16">
          <div className="grid grid-cols-[1fr_2fr] gap-16 items-start">

            <div>
              <div className="text-[9px] font-bold tracking-[2.5px] text-[#999] uppercase mb-4">
                Abstract
              </div>
              <div className="text-[13px] font-bold text-ink leading-[1.4]">
                Reproducible Spectral Data Infrastructure for Chandrayaan-3 LIBS
              </div>
              <div className="mt-5 text-[11px] text-[#999] leading-[1.6]">
                Anand, L. &amp; Saeed, D.<br />
            ...
            <div className="border-l-2 border-[#eee] pl-10">
              <p className="text-[13px] text-[#333] leading-[1.75] mb-4 tracking-[0.2px]">
              ...
              <p className="text-[13px] text-[#333] leading-[1.75] m-0 tracking-[0.2px]">
